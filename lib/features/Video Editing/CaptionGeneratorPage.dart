...
class _CaptionGeneratorPageState extends State<CaptionGeneratorPage> {
      ...
      child: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFFF8E9D2), Color(0xFFB49EF4)], // Adjusting to match the design (Peach to Purple)
          ),
        ),
        child: Scaffold(
        ...
        body: Column(
          children: [
            // Header
            Padding(
              padding: EdgeInsets.only(top: MediaQuery.of(context).padding.top + 10.h, left: 20.w, right: 20.w),
              child: Row(
                children: [
                  GestureDetector(
                  ...
                  children: [
                          ...
                          Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                items: ["BOLD", "CASUAL", "FUNNY", "PROFESSIONAL"]
                                    .map((tone) => DropdownMenuItem(
                                          value: tone,
                                          child: Row(
                                            children: [
                                              const Text("👊 "),
                                              Text(tone, style: const TextStyle(fontWeight: FontWeight.bold)),
                                            ],
                                          ),
                                        ))
                                    .toList(),
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 14.sp, color: Colors.black.withOpacity(0.8), height: 1.5),
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: const Color(0xFFE8E1FF), // Light purple back for emojis
                        borderRadius: BorderRadius.circular(15.r),
                      ),
                      child: Row(
                        children: [
  ...
  Widget _buildHashtagTile(String tag) {
    return Container(
      ...
      child: Text(tag, style: TextStyle(fontSize: 12.sp, fontWeight: FontWeight.bold)),
    );
  }
}
