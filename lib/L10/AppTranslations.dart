...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en': {
      ...
      'feature_dummy': 'Lorem ipsum is dummy text.',
      'faster_processing': 'Faster Image Processing',
      'no_watermarks': 'No Watermarks!',
      'remove_ads': 'Remove Ads',
      'business_manageable': 'Business Manageable',
      ...
      'posts_title': 'Posts',
      'scheduled_posts_tab': 'Scheduled Posts',
      'history_tab': 'History',
      'no_scheduled_posts': 'No Scheduled Posts',
      'no_scheduled_posts_sub': 'Your scheduled posts will appear here.',
      'no_post_history': 'No Post History',
      'no_post_history_sub': 'Your published content will appear here.',
      'today': 'Today',
      'tomorrow': 'Tomorrow',
      'see_all': 'See All',
      'lets_create_post': 'Let’s Create your Next Post',
      'explore_content_ideas': 'Explore the perfect content ideas tailored for your business',
      'reels': 'Reels',
      'posts': 'Posts',
      'stories': 'Stories',
      ...
      'Add Target Audience': 'Add Target Audience',
    },
    'es': {
      ...
      'feature_dummy': 'Lorem ipsum es un texto simulado.',
      'faster_processing': 'Procesamiento de imágenes más rápido',
      'no_watermarks': '¡Sin marcas de agua!',
      'remove_ads': 'Eliminar anuncios',
      'business_manageable': 'Negocio manejable',
      'get_access_now': 'Obtener acceso ahora',
      'terms': 'Términos',
      'privacy': 'Privacidad',
      'restore': 'Restaurar',
      'last_synced': 'Última sincronización: ',
      'posts_title': 'Publicaciones',
      'scheduled_posts_tab': 'Publicaciones programadas',
      'history_tab': 'Historial',
      'no_scheduled_posts': 'Sin publicaciones programadas',
      'no_scheduled_posts_sub': 'Tus publicaciones programadas aparecerán aquí.',
      'no_post_history': 'Sin historial de publicaciones',
      'no_post_history_sub': 'Tu contenido publicado aparecerá aquí.',
      'today': 'Hoy',
      'tomorrow': 'Mañana',
      'see_all': 'Ver todo',
      'lets_create_post': 'Vamos a crear tu próxima publicación',
      'explore_content_ideas': 'Explora las ideas de contenido perfectas para tu negocio',
      'reels': 'Reels',
      'posts': 'Publicaciones',
      'stories': 'Historias',
      ...
      'reel_label': 'Reels',
      'post_label': 'Publicaciones',
      'story_label': 'Historias',
      'under_maintenance': 'En mantenimiento',
      'server_maintenance_msg':
          "Actualmente estamos realizando tareas de mantenimiento en el servidor para mejorar su experiencia. Por favor, inténtelo de nuevo en unos minutos.",
      ...
      'Add Target Audience': 'Agregar Público Objetivo',
    },
    'hi': {
      ...
      'view_all_benefits': 'सभी लाभ देखें',
      'reel_label': 'रील्स',
      'post_label': 'पोस्ट',
      'story_label': 'स्टोरी',
      'under_maintenance': 'रखरखाव चल रहा है',
      'server_maintenance_msg':
          "हम आपकी अनुभव को बेहतर बनाने के लिए वर्तमान में कुछ सर्वर रखरखाव कर रहे हैं। कृपया कुछ मिनटों में पुनः प्रयास करें।",
      'something_went_wrong': 'कुछ गलत हो गया😢',
      'local': 'स्थानीय',
      'tourist': 'पर्यटक',
      'online': 'ऑनलाइन',
      'all': 'सभी',
      'General Audience': 'सामान्य दर्शक',
      'Students': 'छात्र',
      'Professionals': 'पेशेवर',
      'Entrepreneurs': 'उद्यमी',
      'Content Creators': 'सामग्री निर्माता',
      'Target Audience': 'लक्षित दर्शक',
      'Add Target Audience': 'लक्षित दर्शक जोड़ें',
    },
  };
}
